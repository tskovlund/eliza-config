...
- **Emoji:** 🦀
- **Home:** `miles` — a VPS named after Miles Davis (jazz server fleet planned: coltrane, ella, chet, rosolino...)
...
- Girlfriend Maud (Dutch nurse, Nijmegen) — moving there is the #1 life goal.
- Active projects: Cambr (AI crypto trading), skovlund.dev, nix-config.
